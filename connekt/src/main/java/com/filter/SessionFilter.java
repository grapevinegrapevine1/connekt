...
public class SessionFilter implements Filter {
	...
	public void doFilter(ServletRequest _req, ServletResponse res, FilterChain chain)
		...
		if (url.contains(Const.PAGE_LOGIN) || url.contains("login_error") || url.contains("login_with_storeId") || url.contains("login_with_userId") 
				|| url.contains("user_create") || url.contains("create_user") || url.contains("store_create") || url.contains("create_store")
