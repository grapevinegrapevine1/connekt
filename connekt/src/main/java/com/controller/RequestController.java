...
public class RequestController {
	...
	@GetMapping("/account_access")
	public String otherAccountAccess(HttpServletRequest req, HttpServletResponse res) throws Exception {

		Stripe.apiKey = Const.STRIPE_API_KEY;
		AccountCreateParams params = AccountCreateParams.builder().setType(AccountCreateParams.Type.STANDARD).build();
		Account account = Account.create(params);
//		AccountLinkCreateParams params2 =
//				  AccountLinkCreateParams
//				    .builder()
//				    .setAccount(account.getId())
//				    .setRefreshUrl("http://localhost:8081/login")
//				    .setReturnUrl("http://localhost:8081/login")
//				    .setType(AccountLinkCreateParams.Type.ACCOUNT_ONBOARDING)
//				    .build();
//
//		AccountLink accountLink = AccountLink.create(params2);
				
//		CustomerCreateParams params = CustomerCreateParams.builder().setEmail("test6@test.com").build();
//		RequestOptions requestOptions = RequestOptions.builder().setStripeAccount("acct_1KaJJABbtACSed8B").build();
//
